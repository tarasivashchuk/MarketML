...
class DSANet(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        return [optimizer], [scheduler] # is encouraged to try more optimizers and schedulers here

    def dataloader(self, train):
        # init data generators
        set_type = train
        dataset = MTSFDataset(window=self.window, horizon=self.horizon, data_name=self.data_name, set_type=set_type, data_dir=self.data_dir)
    ...
    def train_dataloader(self):
        ...
        return self.dataloader(train='train')

    def val_dataloader(self):
        print('val data loader called')
        return self.dataloader(train='validation')

    def test_dataloader(self):
        print('test data loader called')
        return self.dataloader(train='test')
